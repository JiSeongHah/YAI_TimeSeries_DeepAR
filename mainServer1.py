            ...
            for hiddenSize in hiddenSizeLst:
                for windowRangeTst in windowRangeTstLst:
                    for XrangeNum in  XrangeNumLst:
                        ...
                        savingDir = mk_name(dir1='/',model='divVerRELU',XrangeNum=XrangeNum,hidden=hiddenSize,nlayer=numLayer,linNum=linNum,wdw=windowRangeTst,signum=sigmaNum,bs=bSizeTrn)
