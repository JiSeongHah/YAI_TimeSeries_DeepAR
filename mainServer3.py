...
if __name__ == '__main__':
    ...
    baseDir = '/home/a286/hjs_dir1/g-research-crypto-forecasting/dataset2/'
            ...
            for hiddenSize in hiddenSizeLst:
                for windowRangeTst in windowRangeTstLst:
                    for XrangeNum in  XrangeNumLst:
                        ...
                        savingDir = mk_name(dir3='/',model='divVerRELU',XrangeNum=XrangeNum,hidden=hiddenSize,nlayer=numLayer,linNum=linNum,wdw=windowRangeTst,signum=sigmaNum,bs=bSizeTrn)
